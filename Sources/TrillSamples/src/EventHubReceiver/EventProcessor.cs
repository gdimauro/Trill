...
namespace EventHubReceiver
{
    ...
    public sealed class EventProcessor : IEventProcessor
    {
        ...
        /// <summary>
        /// Delete checkpoints other than specified last checkpoint file using segmented async listing.
        /// </summary>
        private Task DeleteOlderCheckpoints(string checkpointFile)
        {
            ...
            do
            {
                ...
                {
                    if (blob is CloudBlockBlob block && block.Name != checkpointFile)
                    {
                        block.DeleteAsync().GetAwaiter().GetResult();
                    }
                }
